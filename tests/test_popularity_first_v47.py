...
from backend.app.collectors.google_places import SEARCH_SPECS
...
def test_v47_uses_small_broad_popularity_query_set():
    ...
    assert "spatial inventory" in kakao_text.lower()
...
def test_review_volume_and_rating_drive_popularity_order():
    high_volume = {
        "rating": 4.2,
